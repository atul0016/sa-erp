...
export default function StockLedger() {
  ...
  const loadMockData = () => {
    const mockMovements: StockMovement[] = [
      {
        ...
        running_qty: 1500,
        running_value: 97500,
        remarks: 'Against PO-2024-0098',
      },
      {
        id: '2',
        date: '2024-01-15',
        time: '14:00:00',
        voucher_type: 'Production Issue',
        voucher_number: 'PI-2024-0042',
        item_code: 'RM-STEEL-001',
        item_name: 'MS Steel Rod 12mm',
        warehouse: 'Main Warehouse',
        batch_number: 'B20240110',
        movement_type: 'out',
        qty_in: 0,
        qty_out: 200,
        rate: 65,
        ...
        running_qty: 1300,
        running_value: 84500,
        remarks: 'For Job Card JC-2024-0015',
      },
      {
        id: '3',
        date: '2024-01-14',
        ...
        voucher_number: 'ST-2024-0008',
        item_code: 'FG-PUMP-001',
        item_name: 'Centrifugal Pump 2HP',
        warehouse: 'Main Warehouse',
        serial_numbers: ['SN20240001', 'SN20240002'],
        movement_type: 'out',
        qty_in: 0,
        qty_out: 2,
        rate: 15500,
        value: 31000,
        running_qty: 45,
        running_value: 697500,
        remarks: 'Transfer to Branch',
      },
      {
        id: '4',
        date: '2024-01-14',
        ...
        voucher_number: 'INV-2024-0089',
        item_code: 'FG-MOTOR-002',
        item_name: 'Electric Motor 5HP',
        warehouse: 'Main Warehouse',
        serial_numbers: ['SN20240010'],
        movement_type: 'out',
        qty_in: 0,
        qty_out: 1,
        rate: 28500,
      ...
      },
      {
        ...
        date: '2024-01-13',
        time: '09:00:00',
        voucher_type: 'Production Receipt',
        voucher_number: 'PR-2024-0033',
        item_code: 'FG-PUMP-001',
        item_name: 'Centrifugal Pump 2HP',
        warehouse: 'Main Warehouse',
        serial_numbers: ['SN20240001', 'SN20240002', 'SN20240003', 'SN20240004', 'SN20240005'],
        movement_type: 'in',
        qty_in: 5,
        qty_out: 0,
        rate: 15500,
    ...
    // Mock warehouse breakdown
    setWarehouseBreakdown([
      { warehouse: 'Main Warehouse', location: 'Mumbai', stock_qty: 2500, stock_value: 1850000 },
      { warehouse: 'Branch Warehouse', location: 'Pune', stock_qty: 450, stock_value: 520000 },
      { warehouse: 'WIP Storage', location: 'Mumbai', stock_qty: 180, stock_value: 95000 },
    ]);
  };
